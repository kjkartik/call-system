...
class FlutterCallKit {
  ...
  void configure(
    IOSOptions options, {
    required OnReceiveStartCallAction didReceiveStartCallAction,
    required VoidCallback onProviderReset,
    required OnAnswerCallAction performAnswerCallAction,
    required OnEndCallAction performEndCallAction,
    required OnActivateAudioSession didActivateAudioSession,
    required OnDeactivateAudioSession didDeactivateAudioSession,
    required OnIncomingCall didDisplayIncomingCall,
    required OnMuted didPerformSetMutedCallAction,
    required OnDTMF didPerformDTMFAction,
    required OnHold didToggleHoldAction,
    required OnStartCall handleStartCallNotification,
  }) {
    if (!Platform.isIOS) {
      return;
    }
